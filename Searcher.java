...
public class Searcher {
	...
	public void reorderGreedy(String heur) {
		...
		/*for(Node n : orderedSearchQueue) {
			System.out.println("Node in queue: "+n.name+" H(x) = "+(n.h1 +" "+n.h2));
		}
		System.out.println("-------------------");*/
	...
	public void reorderAstar(String heur) {
		...
		/*for(Node n : orderedSearchQueue) {
			if(heur.equals("h1"))
				System.out.println("Node in queue: "+n.name+" H1(x) = "+(n.cost+n.h1));
			else if(heur.equals("h2"))
				System.out.println("Node in queue: "+n.name+" H2(x) = "+(n.cost+n.h2));
		}
		System.out.println("-------------------");*/
		this.queue = orderedSearchQueue;
	}
